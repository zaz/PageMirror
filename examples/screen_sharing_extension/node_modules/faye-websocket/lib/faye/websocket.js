...
import Draft75Parser from './websocket/draft75_parser';

import Draft76Parser from './websocket/draft76_parser';
import HybiParser from './websocket/hybi_parser';
import API from './websocket/api';
import Event from './websocket/api/event';

var getParser = request => {
...
var isSecureConnection = request => {
